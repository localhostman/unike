...
@Component({
  selector: 'app-sale-condition',
  templateUrl: './sale-condition.page.html',
  styleUrls: ['./sale-condition.page.scss'],
...
export class SaleConditionPage extends PageBase implements AfterViewInit {
